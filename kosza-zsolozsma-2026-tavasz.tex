...
\begin{psalmsheet}[tone=8, continuous, number={112. zsoltár}, title={Dicsértessék az Úr neve}, motto={Hatalmasokat ledöntött a trónról, és alázatosakat felmagasztalt (Lk 1, 52).}]
  \psalmtext{
    1. Dicsérjétek, Isten szolgái, * dicsérjétek az Úr nevét. \\
    2. Áldott legyen az Úr neve * mostantól fogva mindörökké. ---

    3. Dicsértessék az Úr neve * napkelettől napnyugatig! \\
    4. Fölséges az Isten minden nép fölött, * dicsősége magasabb az egeknél. \\
    5. Ki hasonlítható Istenünkhöz, az Úrhoz, † kinek magasságokban áll a trónja, * és onnan tekint alá égre és földre? ---

    7. Az elhagyatottat a porból magához vonja, * fölemeli a szegényt a sárból, \\
    8. hogy odaültesse a gazdagok közé, * népének gazdagjai közé. \\
    9. S aki gyermek nélkül élt házában, * azt gyermekek boldog anyjává teszi.
}
\end{psalmsheet}
...
\begin{psalmsheet}[tone=8, continuous, number={115. zsoltár}, title={Hálaadás a templomban}, motto={Krisztus által mutassuk be az Istennek szüntelenül a dicséret áldozatát (Zsid 13, 15).}]
  \psalmtext{
...
\begin{psalmsheet}[tone=3, continuous, title={Ének Krisztusról, Isten Szolgájáról}]
  \psalmtext{
